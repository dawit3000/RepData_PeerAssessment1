...
data1<-subset(datanew_agg, datanew_agg$daytype=="weekend")
data2<-subset(datanew_agg, datanew_agg$daytype=="weekday")
par(mfrow = c(2, 1))
plot(data1$interval,data1$meansteps, type = "l",col = "red")              
plot(data2$interval,data2$meansteps, type = "l",col = "red")  
